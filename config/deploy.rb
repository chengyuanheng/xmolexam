set :application, 'xmolexam'
set :repo_url, 'git@git.xiaoma.com:xmolexam'
set :branch, 'master'
# ask :branch, proc { `git rev-parse --abbrev-ref HEAD`.chomp }
#set :stages, ["production"]

set :deploy_to, '/app/rails/xmolexam.xiaoma.com'
set :scm, :git
...
set :rvm_type, :user
set :rvm_ruby_version, 'ruby-1.9.3-p547@xmolexam' #ruby-1.9.3-p484@xmnewcrm
